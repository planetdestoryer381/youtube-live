...
function loop(){
  ...
  if(state==="PLAY"){
    ...
    for(let y=650;y<950;y++)for(let x=250;x<W-250;x++){const idx=(y*W+x)*3;rgb[idx]=30;rgb[idx+1]=40;rgb[idx+2]=100;}
    drawT("WINNER!",420,680,4,[255,255,255]);blit(W/2,800,winner.i,160,80);drawT(winner.n,350,910,2,[255,255,255]);if(++timer>300)init();
